...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Oliver', 'Seemorebutts', 'Pharmacy Manager', 'oliver@cool.com', '$2b$12$Uc9QHInwXBCdOzp4KxscK.63TuCusz2Ax7RariEJhi1LOv53wR.0e', FALSE); -- id #2
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Carol', 'Davies', 'Pharmacy Technician', 'carol.tech@example.com', '$2b$12$tT7e.YEtU6eoxCYH3LUGqO.0kLWehKA80D/hMEtH/lv3zZvO4m.Qy', FALSE); -- id #3
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Frank', 'Wright', 'Pharmacy Technician', 'frank.tech@example.com', '$2b$12$7CjTRY.PQgUKvNMdq5vro.WncpDTfJ20rv5mog14ZZS92gpJkPGna', FALSE); -- id #6
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Hank', 'Oldman', 'Pharmacy Manager', 'hank.manager@example.com', '$2b$12$.YR6KLtrv9ixoyrT6ZYHWOoO./Z2nofz6FslK37YHQwTjWhdYxwA.', FALSE); -- id #8
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Isabel', 'Raudies', 'Pharmacy Technician', 'isabel.tech@example.com', '$2b$12$Og054nBFVNBk1Z/.DCFXbuVoVqXsSMH73drcCJSCo92pNV4pOa2Ua', FALSE); -- id #9
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Leo', 'Girolami', 'Pharmacy Manager', 'leo.manager@example.com', '$2b$12$xSoMrbLG.Jmph0gZffwlx.VDgu3BaTg55b3tDUrP4fuK5Pl21PPi.', FALSE); -- id #12
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Mary', 'Olsen', 'Pharmacy Technician', 'mary.tech@example.com', '$2b$12$o0QFdyhJ3APZ.n86Qnz0yeFLM8gC0iFnuj5UCoktEROhwT1Kj/.jW', FALSE); -- id #13
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Paul', 'Downs', 'Pharmacy Technician', 'paul.tech@example.com', '$2b$12$Q8T7tbeI3pqoVAt8RBbP9.U4/QIZyHYwhV7ngBPO/F/QRv0FuaCvS', FALSE); -- id #16
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Steve', 'Madden', 'Pharmacy Manager', 'steve.manager@example.com', '$2b$12$ObhfnA0QrGimKzb8EJ6G8OMUDj0JeeZxUZU7LdebIoEreTc7arOh6', FALSE); -- id #19
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Tony', 'Hawk', 'Pharmacy Technician', 'tony.tech@example.com', '$2b$12$GM0mN.jf3aI2oEFsP7EMYOQLHugNoucUJvFzimIcW8Y/pShUviG4W', TRUE); -- id #20
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Wanda', 'Notlost', 'Pharmacy Technician', 'wanda.tech@example.com', '$2b$12$xnrmNLHgSjjfECF5IueZEO8LatXlwiBEqeFSKdnXAnsJepODU9ckC', FALSE); -- id #23
...
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Yvette', 'Cooms', 'Pharmacy Manager', 'yvette.manager@example.com', '$2b$12$uC8NOm5OgKuzD6be9MMvX.Ik6FnvL81Fgq6Tgsha3e3zpul6F21lK', FALSE); -- id #25
INSERT INTO users (first_name, last_name, user_type, email, password, is_locked_out) VALUES ('Steve', 'Lastname', 'Pharmacy Manager', 'user@user.com', '$2b$12$wDmlYBX1ju6tZ8qj8tlo1uh2QtsJlw21CdN18wGf9G8UhseTpIEFq', FALSE); -- id #25
